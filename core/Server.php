...
use function ilm_html_uri as html_uri;
...
class Server{
    ...
    */
    ...
    public function accept($type="html"){
        ...
        $mtype = getv($accept_type, $type, null);
        return $mtype && in_array($mtype, explode(",", $this->HTTP_ACCEPT));
    }

    public function get($name, $default=null){
        return getv($this->data, $name, $default);
    }
    ///<summary></summary>
    /**
    * 
    ...
    */
    public function prepareServerInfo(){
        ...
        $this->IGK_SCRIPT_FILENAME= html_uri(realpath($this->SCRIPT_FILENAME));
        $this->IGK_DOCUMENT_ROOT=  html_uri(realpath($this->DOCUMENT_ROOT))."/";
